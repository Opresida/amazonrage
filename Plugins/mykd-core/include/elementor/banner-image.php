 ...
 * @since 1.0.0
 */
class TG_Banner_Image extends Widget_Base
{
    ...
    {
        return __('Banner Image', 'genixcore');
    }
    ...
    {
        return 'genix-icon eicon-image-rollover';
    }
    ...
    protected function render()
    {
        ...
        <?php if (!empty($tg_image_url)) : ?>
            <div class="slider__img text-center">
                <img src="<?php echo esc_url($tg_image_url); ?>" data-magnetic alt="<?php echo esc_attr($tg_image_alt); ?>">
            </div>
        <?php endif; ?>
...
$widgets_manager->register(new TG_Banner_Image());
